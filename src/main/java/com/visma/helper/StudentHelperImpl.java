...
public class StudentHelperImpl implements StudentHelper {
     ...
     */
    @Override
    public void convertStudentSittingLocationToIntegerCoordinates(List<Student> allStudents) {
     ...
     */
    @Override
    public boolean areEqualMaps (Map<Integer, String> firstMap, Map<Integer, String> secondMap) {
